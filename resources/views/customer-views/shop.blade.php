    ...
    <div class="row">
        ...
        <div class="shop__sidebar">
          ...
          <div class="shop__sidebar__accordion">
            <div class="accordion" id="accordionExample">
                  ...
                  <div class="card-body">
                    <div class="shop__sidebar__categories">
                      <ul class="nice-scroll">
                        <li><a href="#">Hombres (20)</a></li>
                        <li><a href="#">Mujeres (20)</a></li>
                        <li><a href="#">Niños (20)</a></li>
                      </ul>
                    </div>
                  </div>
                </div>
              ...
              <div class="card">
                <div class="card-heading">
                  <a data-toggle="collapse" data-target="#collapseFour">Tamaño</a>
                </div>
      ...
      <div class="col-lg-9">
        ...
        <div class="row">
            ...
            <div class="product__item">
              <div class="product__item__pic set-bg" data-setbg="storage/img/product/product-2.jpg">
                <ul class="product__hover">
                  ...
                  <li><a href="#"><img src="storage/img/icon/compare.png" alt=""> <span>Compare</span></a>
                  </li>
          ...
          <div class="col-lg-4 col-md-6 col-sm-6">
            <div class="product__item">
              <div class="product__item__pic set-bg" data-setbg="storage/img/product/product-9.jpg">
                <ul class="product__hover">
                  <li><a href="#"><img src="storage/img/icon/heart.png" alt=""></a></li>
                  <li><a href="#"><img src="storage/img/icon/compare.png" alt=""> <span>Compare</span></a>
                  </li>
          ...
          <div class="col-lg-4 col-md-6 col-sm-6">
            <div class="product__item sale">
              <div class="product__item__pic set-bg" data-setbg="storage/img/product/product-10.jpg">
                <span class="label">#% Promoción 🔥</span>
                <ul class="product__hover">
                  <li><a href="#"><img src="storage/img/icon/heart.png" alt=""></a></li>
                  <li><a href="#"><img src="storage/img/icon/compare.png" alt=""> <span>Compare</span></a>
          ...
          <div class="col-lg-4 col-md-6 col-sm-6">
            <div class="product__item">
              <div class="product__item__pic set-bg" data-setbg="storage/img/product/product-11.jpg">
                <ul class="product__hover">
                  <li><a href="#"><img src="storage/img/icon/heart.png" alt=""></a></li>
                  <li><a href="#"><img src="storage/img/icon/compare.png" alt=""> <span>Compare</span></a>
                  </li>
          ...
          <div class="col-lg-4 col-md-6 col-sm-6">
            <div class="product__item sale">
              <div class="product__item__pic set-bg" data-setbg="storage/img/product/product-12.jpg">
                <span class="label">#% Promoción 🔥</span>
                <ul class="product__hover">
                  <li><a href="#"><img src="storage/img/icon/heart.png" alt=""></a></li>
                  <li><a href="#"><img src="storage/img/icon/compare.png" alt=""> <span>Compare</span></a>
          ...
          <div class="col-lg-4 col-md-6 col-sm-6">
            <div class="product__item">
              <div class="product__item__pic set-bg" data-setbg="storage/img/product/product-13.jpg">
                <ul class="product__hover">
                  <li><a href="#"><img src="storage/img/icon/heart.png" alt=""></a></li>
                  <li><a href="#"><img src="storage/img/icon/compare.png" alt=""> <span>Compare</span></a>
                  </li>
          ...
          <div class="col-lg-4 col-md-6 col-sm-6">
            <div class="product__item">
              <div class="product__item__pic set-bg" data-setbg="storage/img/product/product-14.jpg">
                <ul class="product__hover">
                  <li><a href="#"><img src="storage/img/icon/heart.png" alt=""></a></li>
                  <li><a href="#"><img src="storage/img/icon/compare.png" alt=""> <span>Compare</span></a>
                  </li>
